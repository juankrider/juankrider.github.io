    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Juan Carlos Cerrato — Ingeniero de Diseño Industrial">
      <div className="space-y-8">
        ...
        <div className="relative">
          <div className="relative aspect-[4/3] overflow-hidden bg-ground border border-ink/15">
            ...
            <button
              onClick={prevImage}
              className="absolute left-3 top-1/2 -translate-y-1/2 mono flex items-center justify-center w-10 h-10 rounded-full border border-ink/25 bg-paper/90 text-ink transition-colors duration-100 hover:border-signal hover:text-signal"
            ...
            <button
              onClick={nextImage}
              className="absolute right-3 top-1/2 -translate-y-1/2 mono flex items-center justify-center w-10 h-10 rounded-full border border-ink/25 bg-paper/90 text-ink transition-colors duration-100 hover:border-signal hover:text-signal"
