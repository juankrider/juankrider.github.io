    ...
    <section id="experience" className="section-padding bg-zinc-50">
      <div className="container-custom">
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <div className="relative border-l border-zinc-200 pl-8 md:pl-10">
            {experiences.map((exp) => (
              <div key={exp.company} className="relative pb-12 last:pb-0">
                <div className="absolute -left-[41px] top-1 flex h-5 w-5 items-center justify-center rounded-full border border-accent bg-zinc-50 md:-left-[49px]">
                ...
                <div className="drawer-card">
                  ...
                  <p className="mt-1 text-sm text-zinc-500">{exp.period}</p>
